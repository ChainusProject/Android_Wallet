package com.hexlant.nper.walletshell.ui;
...
import com.hexlant.nper.walletshell.R;
...
public class RealtimeBlurView extends View {
	...
	public RealtimeBlurView(Context context, AttributeSet attrs) {
		...
		mOverlayColor = a.getColor(R.styleable.RealtimeBlurView_realtimeOverlayColor, 0x25FFFFFF);
		a.recycle();
	}
